package Perl::Critic::Policy::Community::StrictWarnings;
...
Perl::Critic::Policy::Community::StrictWarnings - Always use strict and
...
them into one policy in the C<community> theme. The default modules recognized
